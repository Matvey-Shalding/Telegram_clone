	...
	return (
		<SidebarContext.Provider value={contextValue}>
			<div
				...
				className={cn(
					'group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex overflow-hidden! max-h-screen max-w-[100vw]',
					className
				)}
				{...props}
			>
...
function Sidebar({
	...
	if (isMobile) {
		return (
			<div
				data-slot="sidebar"
				className={cn('bg-sidebar text-sidebar-foreground flex min-h-screen w-full flex-col', className)}
				{...props}
			>
				{children}
			</div>
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
	...
	return (
		<Button
			...
			{...props}
		>
			<PanelLeftIcon className={className} />
