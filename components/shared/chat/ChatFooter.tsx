...
export const ChatFooter: React.FC<Props> = ({ className }) => {
	return (
		<InputGroup className="sticky shrink-0 outline-none! h-12 border-b-0 border-r-0 border-l-0 border-t border-border bottom-0 left-0 bg-[#171717] p-2.5 pl-5 w-full rounded-none text-lg font-medium">
			<InputGroupInput
